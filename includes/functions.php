...
/**
 * Quote SQL identifiers safely (column/table names) using an allowlist.
 * This prevents identifier-based SQL injection when schema varies across installs.
 */
...
if (!function_exists('gdy_load_settings')) {
    ...
    {
        // Defense-in-depth: only allow known column names and quote identifiers safely.
        ...
        if (function_exists('gdy_sql_ident')) {
            ...
            // Backward-compatible fallback (MySQL-style quoting).
