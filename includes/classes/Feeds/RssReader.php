...
/**
 * Lightweight RSS/Atom reader.
 *
 * This file existed in some older builds and got corrupted by merges.
 * We keep it minimal and safe so the runtime never breaks.
 */
final class RssReader
{
     ...
     *
     * @return array<int, array{title:string, link:string, date:?string, description:?string}>
     */
