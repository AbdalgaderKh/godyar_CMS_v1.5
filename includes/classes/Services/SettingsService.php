...
private function loadAllCached(int $ttl = 600): array
{
    $loader = function (): array {
        ...
        // Defense-in-depth: quote identifier with allowlist.
    ...
    public function getValue(string $key, $default = null)
{
    ...
    public function setValue(string $key, $value): void
    {
        ...
        // Avoid duplicate rows on hosts/DBs where the settings table may have
        // been created without a PRIMARY/UNIQUE key on setting_key.
        // Strategy: UPDATE first, then INSERT if nothing updated.
        ...
        try {
            ...
            // Best-effort de-duplication (only if duplicates exist).
            // Keeps the newest updated_at row; does nothing if schema has PK.
            if ($hasUpdatedAt) {
