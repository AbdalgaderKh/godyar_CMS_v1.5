...
public function mostRead(int $limit = 10): array
{
    ...
    /**
     * Archive (latest published news) with pagination.
     *
     * Return shape matches search():
     *  ['items'=>[], 'total'=>int, 'total_pages'=>int, 'page'=>int, 'per_page'=>int]
     */
    public function archive(int $page = 1, int $perPage = 12, array $filters = []): array
    {
        ...
        // Optional filters (safe + tolerant)
        ...
        // Year/month archive filters (based on the configured date column)
        ...
        // LIMIT/OFFSET as integers embedded (avoid driver binding quirks)
