<?php
/**
 * Admin Layout (Clean / CSP-safe)
 * - No inline <style> or <script>
 * - Works on root installs and subfolder installs
 */
...
if ($__basePath === '' && isset($_SERVER['SCRIPT_NAME'])) {
    // e.g. /subdir/admin/news/index.php -> /subdir
...
if (!function_exists('gdy_admin_render')) {
    /**
     * @param string $title
     * @param string $active one of: dashboard, news, categories, users, settings
     * @param callable $contentFn outputs the inner HTML of the page
     */
