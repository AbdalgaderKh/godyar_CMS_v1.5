<?php
// Google News sitemap (dynamic) with light caching.
// Route: /sitemap-news.xml (see app.php)
...
// Google News recommends last 48 hours for news sitemap.
...
try {
    if (isset($GLOBALS['pdo']) && $GLOBALS['pdo'] instanceof PDO) {
        /** @var PDO $pdo */
        $pdo = $GLOBALS['pdo'];
        // Best-effort: support both published_at and created_at
