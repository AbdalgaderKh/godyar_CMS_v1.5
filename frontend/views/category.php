...
<head>
    ...
    <style>
        ...
        .card{background:#fff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 6px 18px rgba(0,0,0,.04)}
        ...
        .empty{padding:24px;border-radius:16px;background:#fff;border:1px dashed #cbd5e1;color:#6b7280}
        .pagination{display:flex;gap:8px;flex-wrap:wrap;margin-top:24px}
        .pagination a,.pagination span{padding:10px 14px;border-radius:10px;background:#fff;border:1px solid #e5e7eb;text-decoration:none;color:#111827}
