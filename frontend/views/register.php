<?php
// frontend/views/register.php
// Variables passed from controller:
//   $reg_error, $reg_success, $reg_csrf, $reg_old
// Common vars usually available:
//   $lang, $dir, $baseUrl
    ...
    <div class="gdy-auth">
      <div class="gdy-auth-card card">
        <div class="card-body">
          ...
          <form method="post" action="<?= htmlspecialchars(rtrim($baseUrl,'/') . '/register', ENT_QUOTES, 'UTF-8') ?>" class="gdy-auth-form" novalidate>
