...
$siteSubtitle = (string)($siteSettings['site_description'] ?? ($siteSettings['site_slogan'] ?? ''));
...
$siteLogo = (string)($siteSettings['site.logo'] ?? $siteSettings['site_logo'] ?? $siteSettings['logo'] ?? '');
$logoUrl = '';
if ($siteLogo !== '') {
...
<header class="site-header" data-hdr-root>
  <div class="container">
    <div class="header-inner">
      <a href="<?= h($rootUrl ?: '/') ?>" class="brand-block">
