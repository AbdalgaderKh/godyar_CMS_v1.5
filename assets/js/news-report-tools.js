/**
 * news-report-tools.js
 * Handles report page toolbar actions and basic TTS controls.
 * Safe to load site-wide: it no-ops if elements are missing.
 */
'use strict';
...
(function(){
  ...
  function toast(msg){
    // lightweight fallback; replace later with your toast UI if available
    try{
  ...
  function initReportTools(){
    ...
    on(shareBtn,'click', async function(){
      ...
      // fallback: open small share panel
