...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (searchInput && searchResults) {
    ...
    // Normalize href so it always points to the correct location even when
    // the current page is under /admin/search/* (prevents /admin/search/admin/*).
    ...
    function normalizeHref(href){
      ...
      // Relative: treat as relative to /admin
