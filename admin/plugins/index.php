...
// Admin bootstrap (auth, DB, translations, helpers)
require_once __DIR__ . '/../_admin_boot.php';

// Backward compatibility: some installs don't define GODYAR_ROOT in _admin_boot.
// We need it here to locate plugin files reliably.
