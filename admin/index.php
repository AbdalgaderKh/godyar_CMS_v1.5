...
if ($pdo instanceof PDO) {
    try { // نتحقق من وجود الجداول قبل الاستعلام لتفادي الأخطاء لو جدول ناقص
	    ...
	    // Column name selectors (avoid undefined vars + SQL syntax errors)
	    // News date column
	    ...
	    // Visits date column (used for charts when visits table exists)
...
// visits table schema can differ between installs (created_at/user_ip) vs (visit_time/ip_address)
$visitsTimeCol = null;
$visitsIpCol   = null;
