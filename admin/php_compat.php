...
<style>body{font-family:Arial,sans-serif;background:#f6f8fb;padding:24px}table{border-collapse:collapse;width:100%;background:#fff}th,td{border:1px solid #ddd;padding:10px;text-align:right}.ok{color:#0a7}.warn{color:#b8860b}.fail{color:#b00}</style></head><body>
