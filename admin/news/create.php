...
HTACCESS;
    ...
    if (!$errors) {
        try {
            ...
            // PRO i18n: save inline translations from create form (EN/FR)
            try {
                ...
                <div class="gdy-options-box mt-3" id="i18n-inline-box">
                  ...
                  <div class="gdy-tr-pane" data-lang="en">
                    <div class="mb-2">
                      ...
                      <input type="text" class="form-control form-control-sm" name="tr[en][title]" value="<?php echo h((string)($_POST['tr']['en']['title'] ?? '')); ?>" autocomplete="off">
                    </div>
                    <div class="mb-2">
                      <label class="gdy-form-label">Excerpt (EN)</label>
                      <textarea class="form-control form-control-sm" name="tr[en][excerpt]" rows="2"><?php echo h((string)($_POST['tr']['en']['excerpt'] ?? '')); ?></textarea>
                    </div>
                    <div class="mb-1">
                      <label class="gdy-form-label">Content (EN)</label>
                      <textarea class="form-control form-control-sm" name="tr[en][content]" rows="6"><?php echo h((string)($_POST['tr']['en']['content'] ?? '')); ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="gdy-tr-pane d-none" data-lang="fr">
                    <div class="mb-2">
                      ...
                      <input type="text" class="form-control form-control-sm" name="tr[fr][title]" value="<?php echo h((string)($_POST['tr']['fr']['title'] ?? '')); ?>" autocomplete="off">
                    </div>
                    <div class="mb-2">
                      <label class="gdy-form-label">Résumé (FR)</label>
                      <textarea class="form-control form-control-sm" name="tr[fr][excerpt]" rows="2"><?php echo h((string)($_POST['tr']['fr']['excerpt'] ?? '')); ?></textarea>
                    </div>
                    <div class="mb-1">
                      <label class="gdy-form-label">Contenu (FR)</label>
                      <textarea class="form-control form-control-sm" name="tr[fr][content]" rows="6"><?php echo h((string)($_POST['tr']['fr']['content'] ?? '')); ?></textarea>
                    </div>
                  </div>
                </div>
