...
// -----------------------------------------------------------------------------
// PRO i18n: preload translations for editor (EN/FR)
// -----------------------------------------------------------------------------
$tr = [
...
if (isset($_POST['delete_attachment_id'])) {
    ...
    if (!$errors) {
        ...
        if (!$errors) {
            ...
            // -----------------------------------------------------------------
            // PRO i18n: save inline translations from editor (EN/FR)
            // Fields: tr[en][title|excerpt|content], tr[fr][...]
            // -----------------------------------------------------------------
            try {
                if (function_exists('gdy_db_table_exists') && gdy_db_table_exists($pdo, 'i18n_fields')) {
