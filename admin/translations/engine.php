...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (isset($_POST['enqueue_news_id'], $_POST['target_lang'])) {
            ...
            $message = 'Translation job queued: #' . $jobId;
...
h1,h2{margin-top:0}
input,select,button{padding:10px 12px;border:1px solid #d9dfeb;border-radius:10px;font-size:14px}
button{cursor:pointer}
table{width:100%;border-collapse:collapse}
th,td{padding:10px;border-bottom:1px solid #eef2f7;text-align:right;vertical-align:top}
