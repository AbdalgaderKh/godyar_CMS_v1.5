<?php
// Godyar CMS - Admin Settings Hub
// Fix v4: robust bootstrap + robust admin header/footer discovery (includes OR layout).
// Never returns a blank page; shows in-page warnings instead.

@ini_set('display_errors', '0');

// ---- Bootstrap loader (robust path detection) ----
...
if ($__gdy_app_start) {
  ...
  // If base URL is empty, infer from current request (best effort).
  ...
  $__gdy_bootstrap_error = "Godyar CMS: لم يتم العثور على ملف الإقلاع app_start.php";
}


// Resolve admin base URL safely (GDY_ADMIN_URL might be defined but empty)
...
// ---- Tab routing (backward/forward compatibility) ----
...
// If header is missing, render a minimal shell so the page isn't blank.
...
// If bootstrap failed, show a warning but still attempt to render hub.
...
<?php
// If header/footer missing, show a clear message (in-page).
...
?>
  <div class="alert alert-warning">
    <div class="fw-bold mb-1">Godyar CMS: ملفات واجهة لوحة التحكم غير موجودة (admin_header/admin_footer أو header/footer).</div>
...
<div class="gdy-admin-container">
  <div class="gdy-settings-tabs" role="navigation" aria-label="settings_tabs">
