...
if (!function_exists('settings_save')) {
    function settings_save(array $pairs): void {
        ...
        try {
            ...
            // --------------------------------------------------------------
            // IMPORTANT: invalidate cached settings
            // Settings are cached under `site_settings_all_v1` (see
            // includes/site_settings.php). Without clearing it, changes like
            // admin theme won't reflect until cache expiry.
            // --------------------------------------------------------------
            try {
                // If Laravel's Cache facade (class alias) exists, clear settings cache.
            ...
            // Refresh per-request static cache if available.
