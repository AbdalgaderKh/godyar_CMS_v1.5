...
if ((string)gdy_get_server_raw('REQUEST_METHOD', 'GET') === 'POST') {
    ...
    if (!$error) {
        ...
        // Username/email-based rate limiting (defense against distributed attacks)
...
$_SESSION['__gdy_rotated_at'] = time();
        ...
        // Use real file targets to avoid pretty-route collisions on some servers
        // where /admin/index is handled by the frontend router.
