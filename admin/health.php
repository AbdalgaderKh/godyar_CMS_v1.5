...
<head>
  ...
  <style nonce="<?= h($cspNonce) ?>">
    ...
    .card{background:#fff; border:1px solid #e6e8ef; border-radius:14px; padding:18px; max-width:980px; margin:auto;}
    h1{margin:0 0 10px; font-size:20px;}
    p{margin:0 0 14px; color:#555;}
    table{width:100%; border-collapse:collapse;}
    th,td{padding:10px 12px; border-bottom:1px solid #eef0f6; text-align:right; vertical-align:top;}
