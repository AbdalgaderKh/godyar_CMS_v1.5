 ...
 *
 * Usage:
 *   php tools/usage_map.php
 *
 * Output:
 *   storage/reports/usage_map.json
 *
 * Notes:
 * - This script scans PHP/HTML/JS/CSS for '/assets/...' references.
 * - It is conservative: it only REPORTS, does not delete.
 */
