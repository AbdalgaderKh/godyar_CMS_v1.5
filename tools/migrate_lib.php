<?php
/**
 * Godyar CMS — Database migrations library
 *
 * الهدف: تشغيل الترقيات بدون الاعتماد على CLI (لأن بعض الاستضافات
 * تستخدم lsphp قديم في سطر الأوامر). يمكن استدعاؤه من لوحة التحكم.
 *
 * Compatible with PHP 5.6+ (no strict_types, no scalar type hints)
 */
...
if (!function_exists('gdy_run_migrations')) {
    /**
     * Runs migrations and returns: array(ok(bool), output(string))
     */
